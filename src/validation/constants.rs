...
pub const HARDWARE_VENDORS: &[&str] = &[
    ...
    "Intel", "Intel Corporation", "Advanced Micro Devices", "AMD", "NVIDIA", "NVIDIA Corporation",
    "Qualcomm", "Apple", "Arm", "ARM", "MediaTek", "Broadcom", "Marvell", "Texas Instruments",
    
    // Memory vendors
    "Samsung", "SK Hynix", "Micron", "Corsair", "Crucial", "Kingston", "G.Skill", "Team Group",
    "Patriot", "ADATA", "PNY", "Mushkin", "Ballistix", "HyperX",
    
    // Storage vendors
    "Western Digital", "WD", "Seagate", "Toshiba", "SanDisk", "Crucial", "Intel", "Samsung",
    "Micron", "ADATA", "Kingston", "PNY", "Mushkin", "Corsair", "Sabrent", "WD_BLACK",
    
    // Network vendors
    "Realtek", "Intel", "Broadcom", "Qualcomm", "TP-Link", "Netgear", "D-Link", "ASUS",
    "Linksys", "Cisco", "Ubiquiti", "Mikrotik",
    
    // Audio vendors
    "Creative", "Creative Labs", "Realtek", "VIA", "C-Media", "ESS", "Cirrus Logic",
    "Yamaha", "Roland", "Focusrite", "PreSonus", "Behringer",
    
    // System vendors
    "Dell", "HP", "Hewlett-Packard", "Lenovo", "IBM", "Acer", "ASUS", "MSI", "Gigabyte",
    "ASRock", "Supermicro", "Tyan", "Biostar", "ECS", "Foxconn", "Shuttle", "Zotac",
    
    // Peripheral vendors
    "Logitech", "Razer", "Corsair", "SteelSeries", "HyperX", "Roccat", "Cooler Master",
    "Thermaltake", "NZXT", "be quiet!", "Fractal Design", "Phanteks",
    
    // Legacy vendors
    "3dfx", "S3", "Matrox", "ATI", "VIA", "SiS", "Cyrix", "Trident", "Tseng Labs",
    
    // Specialized vendors
    "Elgato", "Elgato Systems", "Hauppauge", "BlackMagic", "AVerMedia", "Magewell",
    "Linux Foundation", "VIA Labs", "Genesys Logic", "ASMedia", "JMicron", "Etron"
];
...
/// Audio device types
pub const AUDIO_DEVICE_TYPES: &[&str] = &[
    "playback", "capture", "duplex", "midi"
];

/// Memory technology types
pub const MEMORY_TYPES: &[&str] = &[
    "DDR2", "DDR3", "DDR4", "DDR5", "LPDDR4", "LPDDR5"
];

/// USB specification versions
pub const USB_VERSIONS: &[&str] = &[
    "1.0", "1.1", "2.0", "3.0", "3.1", "3.2"
];

/// Storage interface types
pub const STORAGE_INTERFACES: &[&str] = &[
    "SATA", "NVMe", "PCIe", "USB", "IDE", "SCSI"
];